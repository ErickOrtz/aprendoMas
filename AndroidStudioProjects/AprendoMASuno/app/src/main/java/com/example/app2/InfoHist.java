...
public class InfoHist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_hist);

        frameLayout = findViewById(R.id.floatingWindowHistory);
        botonVideo = findViewById(R.id.botonVideo);
        botonCerrar = findViewById(R.id.closeButton);
        videoView = findViewById(R.id.videoViewHistory);
        ...
        String videoUri = "android.resource://" + getPackageName() + "/" + R.raw.hist;
    ...
    public void onBackPressed() {
        MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(InfoHist.this);
        ...
        materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, (dialogInterface, i) -> {
            startActivity(new Intent(InfoHist.this, MainActivity.class));
            finish();
        });
