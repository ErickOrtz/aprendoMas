...
public class PlanetsClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonNext.setOnClickListener(v -> {
            ...
            if (currentQuestions < questionsItems.size() - 1) {
                ...
                Intent intent1 = new Intent(PlanetsClass.this, ResultActivity.class);
 ...
 //   }
    ...
    private void loadAllQuestions() {
        ...
        String jsonquiz = loadJsonFromAsset("planets.json");
        try {
            JSONObject jsonObject = new JSONObject(jsonquiz);
            JSONArray questions = jsonObject.getJSONArray("planets");
    ...
    public void onBackPressed() {
        MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(PlanetsClass.this);
        ...
        materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, (dialogInterface, i) -> {
            startActivity(new Intent(PlanetsClass.this, MainActivity.class));
            finish();
        });
    ...
    private void CargarEstilo() {
        ...
        try {
            ...
            JSONArray mathematics = jsonObject.getJSONArray("planets");
