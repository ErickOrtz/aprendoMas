...
public class EspClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonNext.setOnClickListener(v -> {
            ...
            if (currentQuestions < questionsItems.size() - 1) {
                ...
                Intent intent1 = new Intent(EspClass.this, ResultActivity.class);
 ...
 //   }
    ...
    private void loadAllQuestions() {
        ...
        String jsonquiz = loadJsonFromAsset("spanishQuestions.json");
        try {
            JSONObject jsonObject = new JSONObject(jsonquiz);
            JSONArray questions = jsonObject.getJSONArray("Esp");
    ...
    public void onBackPressed() {
        MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(EspClass.this);
        materialAlertDialogBuilder.setTitle(R.string.app_name);
        materialAlertDialogBuilder.setMessage("¿Sguro que deseas salir del quiz?");
        ...
        materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, (dialogInterface, i) -> {
            startActivity(new Intent(EspClass.this, MainActivity.class));
            finish();
        });
    ...
    private void CargarEstilo() {
        ...
        try {
            ...
            JSONArray mathematics = jsonObject.getJSONArray("spanish");
