...
public class HistClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonNext.setOnClickListener(v -> {
            ...
            if (currentQuestions < questionsItems.size() - 1) {
                ...
                Intent intent1 = new Intent(HistClass.this, ResultActivity.class);
 ...
 //   }
    ...
    private void loadAllQuestions() {
        ...
        try {
            ...
            JSONArray questions = jsonObject.getJSONArray("Hist");
    ...
    public void onBackPressed() {
        MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(HistClass.this);
        ...
        materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, (dialogInterface, i) -> {
            startActivity(new Intent(HistClass.this, MainActivity.class));
            finish();
        });
    ...
    private void CargarEstilo() {
        ...
        try {
            ...
            JSONArray mathematics = jsonObject.getJSONArray("history");
