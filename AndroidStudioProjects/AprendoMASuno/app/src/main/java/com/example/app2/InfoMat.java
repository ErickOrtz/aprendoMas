...
public class InfoMat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_mat);
        ...
        String videoUri = "android.resource://" + getPackageName() + "/" + R.raw.mat;
    ...
    public void onBackPressed() {
        MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(InfoMat.this);
        ...
        materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, (dialogInterface, i) -> {
            startActivity(new Intent(InfoMat.this, MainActivity.class));
            finish();
        });
